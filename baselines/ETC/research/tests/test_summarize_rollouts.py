...
class SummarizeTests(unittest.TestCase):
    def test_benefits_flips_oracle_and_groups(self):
        bundle = {
            ...
            "actions": [
                {"state_id": "s1", "action_type": "skip", "scores": {"f1": 0.0, "accuracy": 0}},
                {"state_id": "s1", "action_type": "retrieve", "query_candidate_id": "q1", "scores": {"f1": 1.0, "accuracy": 1}},
                {"state_id": "s2", "action_type": "skip", "scores": {"f1": 0.0, "accuracy": 0}},
                {"state_id": "s2", "action_type": "retrieve", "query_candidate_id": "q2", "scores": {"f1": 0.0, "accuracy": 0}},
            ],
        }
